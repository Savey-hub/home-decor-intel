...
gate_note = {
    ...
    'xhs': "第2轮补采仍受限：小红书家生活垂类蒲公英/千帆商业化新政为授权状态页面，公开面无窗口内可溯源官方动态，待强登录后台补采",
    'shipinhao': "第2轮补采仍受限：视频号/微信小店家居家装成长中心为授权状态，公开面无窗口内可溯源专项战报/新政",
...
pd['asOf'] = '2026-07-30'
pd.setdefault('gaps', [])
gapmsg_pf = "【第2轮07-16~07-29窗口深挖说明】该窗口在电商平台公开面客观偏薄：各平台官方规则/招商页(抖店学习中心、淘宝大学、微信小店成长中心、磁力金牛)均为JS动态渲染或需授权状态，WebFetch无法取正文；本轮仅京东『春晓计划』半年战报(07-22,新浪财经)达『实开+日期在窗口+可溯源』标准并入库。pdd/xhs/视频号/快手/天猫窗口内公开可溯源动态稀少，需强登录商家后台陪跑补采。"
